...
Image similarity is akin to co-localization, but not precisely. For more literature on co-localization, see also:
...
| Image A | Image B |
| ---------------------------------------- | ---------------------------------------- |
| ![Test image 1](images/img3__a_test.png) | ![Test image 1](images/img3__b_test.png) |
...
$\frac{1}{n} \sum_{i=1}^{n} ( Z )$ calculates the expected value $E(Z)$, of $Z$.
In this case, 
